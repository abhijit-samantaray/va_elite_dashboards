# The name of this view in Looker is "Ccaidata"
view: ccaidata {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ccai_dataset_bigquery.ccai-data`
    ;;
...
# The name of this view in Looker is "Ccai-data Words"
view: ccai-data__words {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ccaidata__words {
    type: string
    description: "The list of all spoken words."
    hidden: yes
    sql: `ccai-data__words`
      ;;
  }
...
# The name of this view in Looker is "Ccai-data Issues"
view: ccai-data__issues {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai-data Labels"
view: ccai-data__labels {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai-data Entities"
view: ccai-data__entities {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ccaidata__entities {
    type: string
    description: "The list of all spoken entities."
    hidden: yes
    sql: `ccai-data__entities`
      ;;
  }
...
# The name of this view in Looker is "Ccai-data Sentences"
view: ccai-data__sentences {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  # Here's what a typical dimension looks like in LookML.
  # A dimension is a groupable field that can be used to filter query results.
  # This dimension will be called "Ccaidata Sentences" in Explore.

  dimension: ccaidata__sentences {
    type: string
    description: "The list of conversation sentences."
    hidden: yes
    sql: `ccai-data__sentences`
      ;;
  }
...
# The name of this view in Looker is "Ccai-data Sentences Annotations"
view: ccai-data__sentences__annotations {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: record {
    type: string
    description: "The suggestion content returned from Dialogflow, serialised as JSON."
    sql: ${TABLE}.record ;;
  }
...
# The name of this view in Looker is "Ccai-data Sentences Highlight Data"
view: ccai-data__sentences__highlight_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai-data Sentences Intent Match Data"
view: ccai-data__sentences__intent_match_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai-data Sentences Phrase Match Data"
view: ccai-data__sentences__phrase_match_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai-data Sentences Dialogflow Intent Match Data"
view: ccai-data__sentences__dialogflow_intent_match_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.

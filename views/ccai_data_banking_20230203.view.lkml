# The name of this view in Looker is "Ccai Data Banking 20230203"
view: ccai_data_banking_20230203 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ccai_dataset_bigquery.ccai_data_banking_20230203`
    ;;
...
# The name of this view in Looker is "Ccai Data Banking 20230203 Words"
view: ccai_data_banking_20230203__words {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ccai_data_banking_20230203__words {
    type: string
    description: "The list of all spoken words."
    hidden: yes
    sql: ccai_data_banking_20230203__words ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking 20230203 Issues"
view: ccai_data_banking_20230203__issues {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ccai_data_banking_20230203__issues {
    type: string
    description: "The list of all issues of the conversation."
    hidden: yes
    sql: ccai_data_banking_20230203__issues ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking 20230203 Labels"
view: ccai_data_banking_20230203__labels {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ccai_data_banking_20230203__labels {
    type: string
    description: "The list of all user-provided labels."
    hidden: yes
    sql: ccai_data_banking_20230203__labels ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking 20230203 Entities"
view: ccai_data_banking_20230203__entities {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ccai_data_banking_20230203__entities {
    type: string
    description: "The list of all spoken entities."
    hidden: yes
    sql: ccai_data_banking_20230203__entities ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking 20230203 Sentences"
view: ccai_data_banking_20230203__sentences {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  # Here's what a typical dimension looks like in LookML.
  # A dimension is a groupable field that can be used to filter query results.
  # This dimension will be called "Ccai Data Banking 20230203 Sentences" in Explore.

  dimension: ccai_data_banking_20230203__sentences {
    type: string
    description: "The list of conversation sentences."
    hidden: yes
    sql: ccai_data_banking_20230203__sentences ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking 20230203 Sentences Annotations"
view: ccai_data_banking_20230203__sentences__annotations {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: record {
    type: string
    description: "The suggestion content returned from Dialogflow, serialized as JSON."
    sql: ${TABLE}.record ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking 20230203 Sentences Highlight Data"
view: ccai_data_banking_20230203__sentences__highlight_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai Data Banking 20230203 Sentences Intent Match Data"
view: ccai_data_banking_20230203__sentences__intent_match_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai Data Banking 20230203 Sentences Phrase Match Data"
view: ccai_data_banking_20230203__sentences__phrase_match_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai Data Banking 20230203 Sentences Dialogflow Intent Match Data"
view: ccai_data_banking_20230203__sentences__dialogflow_intent_match_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.

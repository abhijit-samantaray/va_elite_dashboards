# The name of this view in Looker is "Ccai Data Banking"
view: ccai_data_banking {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ccai_dataset_bigquery.ccai_data_banking`
    ;;
...
# The name of this view in Looker is "Ccai Data Banking Words"
view: ccai_data_banking__words {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ccai_data_banking__words {
    type: string
    description: "The list of all spoken words."
    hidden: yes
    sql: ccai_data_banking__words ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking Issues"
view: ccai_data_banking__issues {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ccai_data_banking__issues {
    type: string
    description: "The list of all issues of the conversation."
    hidden: yes
    sql: ccai_data_banking__issues ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking Labels"
view: ccai_data_banking__labels {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ccai_data_banking__labels {
    type: string
    description: "The list of all user-provided labels."
    hidden: yes
    sql: ccai_data_banking__labels ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking Entities"
view: ccai_data_banking__entities {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ccai_data_banking__entities {
    type: string
    description: "The list of all spoken entities."
    hidden: yes
    sql: ccai_data_banking__entities ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking Sentences"
view: ccai_data_banking__sentences {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  # Here's what a typical dimension looks like in LookML.
  # A dimension is a groupable field that can be used to filter query results.
  # This dimension will be called "Ccai Data Banking Sentences" in Explore.

  dimension: ccai_data_banking__sentences {
    type: string
    description: "The list of conversation sentences."
    hidden: yes
    sql: ccai_data_banking__sentences ;;
  }
...
# The name of this view in Looker is "Ccai Data Banking Sentences Annotations"
view: ccai_data_banking__sentences__annotations {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai Data Banking Sentences Highlight Data"
view: ccai_data_banking__sentences__highlight_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai Data Banking Sentences Intent Match Data"
view: ccai_data_banking__sentences__intent_match_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai Data Banking Sentences Phrase Match Data"
view: ccai_data_banking__sentences__phrase_match_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Ccai Data Banking Sentences Dialogflow Intent Match Data"
view: ccai_data_banking__sentences__dialogflow_intent_match_data {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
